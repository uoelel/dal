...
cat("Which of the following is an absolute paths?", longmcq(opts_1))
```
:::
...
1.  Download the file with the data by right-clicking on the following link and download the file: [song2020/shallow.csv](../data/song2020/shallow.csv). (Note that tutorial files are also linked in the [Course content](../content.qmd) page)
...
Then we can use the `read_excel()` function, but first you should download the Excel file we will read.

1.  Download the file with the data by right-clicking on the following link and download the file: [los2023/relatives.xlsx](../data/los2023/relatives.xlsx). (Note that tutorial files are also linked in the [Course content](../content.qmd) page)

2.  Move the file to the `data/` folder of the Quarto project.
...
Download the following files and move them into the data folder. Read them in R, making sure you use the right `read_*()` function.
