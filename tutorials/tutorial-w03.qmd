...
1.  Download the file with the data by right-clicking on the following link and download the file: [song2020.csv](../data/song2020.csv). (Note that tutorial files are also linked in the [Course content](../content.qmd) page)
