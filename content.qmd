...
| 7      | [Tidy data](slides/lecture-w07.qmd)                            | Data tidying                                           | F2                                     |
...
| 4   | ggplot(), aes(), geom_point(), labs(), colour and alpha, scale_colour_brewer(), scale_colour_viridis_d(), \|\>     | [polite](data/winter2012/polite.qmd)                                                                                           |
| 5   | filter(), mutate(), geom_bar(), as.factor(), factor(), facet_grid()                                                | [glot_status](data/coretta2022/glot_status.qmd), [polite](data/winter2012/polite.qmd)                                          |
