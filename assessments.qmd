...
The first summative contains 4 guided exercises that cover things done in Weeks 1 to 7.
...
For the second summative assessment you will have to find a data set from published research and write a short data analysis report on the chosen data.
